...
--
-- Host: localhost
-- Generation Time: 13 Jul 2018 pada 09.29
...
(46, 'SUK1001', 'PEG1006', 6),
(47, 'SUK1002', 'PEG1006', 6),
(48, 'SUK1002', 'PEG1010', 6),
(54, 'SUK1003', 'PEG1006', 6),
(55, 'SUK1004', 'PEG1006', 6);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tb_detail_surat_masuk`
--

CREATE TABLE `tb_detail_surat_masuk` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_detail_surat_masuk`
--

INSERT INTO `tb_detail_surat_masuk` (`id`, `id_surat_masuk`, `id_jabatan`) VALUES
(4, 'SUM1001', 7),
(5, 'SUM1001', 8),
(6, 'SUM1001', 9),
(7, 'SUM1001', 10),
...
INSERT INTO `tb_jenis_surat` (`id_jenis_surat`, `no_surat`, `jenis_surat`, `isi_surat`, `lampiran`) VALUES
(5, 'BKPPD.890', 'Pengambilan Sertifikat Diklat', '<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Sesuai Perihal Surat Edaran diatas, maka dengan ini disampaikan bhwa sertifikat Pendidikan dan Pelatihan Teknis Tugas dan Fungsi PNS Lingkup Pemerintah Kabupaten Manggarai Barat sudah ada, oleh karena itu diminta bantuan pimpinan OPD agar menyampaikan kepada staf untuk segera mengambil sertifikat di Badan Kepegawaian Pendidikan dan Pelatihan Daerah Kabupaten Mangarai Barat cq. Bidang Perencanaan dan Diklat BKPPD Kabupaten Manggarai Barat setiap jam kerja.</span></span></p>\r\n\r\n<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Demikian untuk maklum dan atas kerjasamamya diucapkan terima kasih.</span></span></p>\r\n', '<div style=\"width:100%; text-align: center\"> <h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3> <table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">      <thead>         <tr>             <th>NO</th>             <th>NAMA</th>             <th>NIP</th>         </tr>     </thead>      <tbody>         <tr>             <td></td>             <td></td>             <td></td>         </tr>     </tbody>  </table> </div>'),
(6, 'BKPPD.822', 'Kenaikan Gaji Berkala', '<p><span style=\"font-size:14px\">Dengan ini diberitahukan bahwa berhubung dengan telah dipenuhi masa kerja dan syarat-syarat lain nya kepada :</span></p>\r\n\r\n<p><span style=\"font-size:14px\">1. Nama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: .........<br />\r\n2. Nomor Induk Pegawai (NIP)&nbsp; &nbsp; &nbsp; : .........<br />\r\n3. Pangkat/Golongan Ruang Gaji &nbsp;: .........<br />\r\n4. Unit Kerja&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Badan Kepegawaian, Pendidikan dan Pelatihan Daerah Kabupaten Manggarai Barat<br />\r\n5. Gaji Pokok Lama&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Rp. ......</span></p>\r\n\r\n<p><span style=\"font-size:14px\">&nbsp; &nbsp; (Atas dasar SKP terakhir tentang gaji/pangkat yang ditetapkan):<br />\r\n&nbsp; &nbsp;&nbsp;<br />\r\n&nbsp; &nbsp; a. Oleh Pejabat&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Bupati Manggarai Barat<br />\r\n&nbsp; &nbsp; b. Tanggal&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: .......<br />\r\n&nbsp; &nbsp; c. Nomor&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: .......<br />\r\n&nbsp; &nbsp; d. Tanggal berlakunya Gaji tersebut&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;:&nbsp;.......<br />\r\n&nbsp; &nbsp; e. Masa Kerja Golongan pada tanggal tersebut : .......</span></p>\r\n\r\n<p><span style=\"font-size:14px\">&nbsp; &nbsp; Diberikan gaji berkala hingga memperoleh :</span></p>\r\n\r\n<p><span style=\"font-size:14px\">6. Gaji Pokok Baru&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Rp. ......<br />\r\n7. Berdasarkan Maasa Kerja&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : ......<br />\r\n8. Pangkat/Golongan ruang&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : ......<br />\r\n9. Terhitung Mulai Tanggal&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : ......<br />\r\n10.TMT Gaji Berkala berikutnya&nbsp; &nbsp; &nbsp; : ......</span></p>\r\n\r\n<p><span style=\"font-size:14px\">Diharapkan agar sesuai dengan peraturan pemerintah Nomor 30 Tahun 2015, maka kepada pegawai negeri sipil tersebut dapat dibayarkan penghasilan nya sebesar gaji yang baru.</span></p>\r\n', '<div style=\"width:100%; text-align: center\"> <h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3> <table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">      <thead>         <tr>             <th>NO</th>             <th>NAMA</th>             <th>NIP</th>         </tr>     </thead>      <tbody>         <tr>             <td></td>             <td></td>             <td></td>         </tr>     </tbody>  </table> </div>'),
(10, 'BKPPD.823', 'Kenaikan Pangkat', '<ol>\r\n	<li style=\"text-align:justify\"><span style=\"font-size:14px\">Bersama ini kami sampikan dengan hormat, usul kenaikan pangkat Pegawai Negeri Sipil dilingkungan Pemerintah Kabupaten Manggarai Barat sebagaimana tersebut di bawah ini.&nbsp;</span></li>\r\n</ol>\r\n\r\n<table align=\"center\" border=\"1\" cellpadding=\"1\" cellspacing=\"1\" style=\"text-align:justify; width:700px\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"text-align:center\"><span style=\"font-size:14px\">NO</span></td>\r\n			<td rowspan=\"1\" style=\"text-align:center\"><span style=\"font-size:14px\">NAMA/NIP</span></td>\r\n			<td colspan=\"2\" rowspan=\"1\" style=\"text-align:center\"><span style=\"font-size:14px\">PANGKAT/GOLONGAN RUANG</span></td>\r\n			<td style=\"text-align:center\"><span style=\"font-size:14px\">JABATAN</span></td>\r\n		</tr>\r\n		<tr>\r\n			<td>&nbsp;</td>\r\n			<td rowspan=\"1\">&nbsp;</td>\r\n			<td rowspan=\"1\">&nbsp;</td>\r\n			<td rowspan=\"1\">&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n\r\n<p style=\"text-align:justify\"><span style=\"font-size:14px\">Sesuai ketentuan dalam Peraturan Pemerintah Nomor 99 tahun 2000 j0 Peraturan Pemerintah Nomor 12 Tahun 2002, yang bersangkutan telah memenuhi syarat untuk dapat dipertimbangkan kenaikan pangkatnya setingkat lebih tinggi</span></p>\r\n\r\n<p style=\"margin-left:0cm; margin-right:0cm; text-align:justify\"><span style=\"font-size:14px\">2.&nbsp;Demikian atas perhatian dan perkenaanya, kami ucapkan terima kasih.</span></p>\r\n', '<div style=\"width:100%; text-align: center\"> <h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3> <table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">      <thead>         <tr>             <th>NO</th>             <th>NAMA</th>             <th>NIP</th>         </tr>     </thead>      <tbody>         <tr>             <td></td>             <td></td>             <td></td>         </tr>     </tbody>  </table> </div>'),
(11, 'BKPPD.875', ' Usulan Karpeg', '<table align=\"center\" border=\"1\" cellspacing=\"0\" class=\"MsoTableGrid\" style=\"border-collapse:collapse; border:solid windowtext 1.0pt\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"vertical-align:top; width:33.75pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">No</span></span></p>\r\n			</td>\r\n			<td style=\"vertical-align:top; width:205.65pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">Jenis Surat yang dikirim</span></span></p>\r\n			</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">Banyaknya</span></span></p>\r\n			</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">Keterangan</span></span></p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"vertical-align:top; width:33.75pt\">&nbsp;</td>\r\n			<td style=\"vertical-align:top; width:205.65pt\">&nbsp;</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">&nbsp;</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', '<div style=\"width:100%; text-align: center\">  <h3 >NOMINATIF USULAN PENETAPAN KARTU PEGAWAI</h3>      <h3 >KABUPATEN MANGGARAI BARAT</h3>       <table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">              <thead>         <tr>                          <th>NO</th>             <th>NAMA/NIP</th>                          <th>TEMPAT/TGL LAHIR</th>                          <th>PANGKAT/GOL</th>                          <th>JABATAN</th>                          <th>UNIT KERJA</th>                      <th>KET</th>         </tr>       </thead>        <tbody>         <tr>                          <td>1</td>                          <td>2</td>                          <td>3</td>                          <td>4</td>                          <td>5</td>                          <td>6</td>               <td>7</td>                </tr>       </tbody>             </table> </div>'),
(14, 'BKPPD.810', 'Kelengkapan Berkas CPNS', '<p><span style=\"font-size:14px\">Menunjuk surat Kepala Bidang Pengangkatan dan Pensiun Kantor Regional X BKN Nomor : 007/KR.X.C1/VII/2017, tanggal 17 Juli 2017. Perihal Pengembalian Berkas Usul Penetapan NIP GGD Kemendikbud Tahun 2017 ( sebayak 12 orang) a.n Laurensius Logot, dkk, maka setelah ke 12 CPNS tersebut memperbaiki bahan-bahan yang kurang dengan ini kami menyampaikan kembali kelengkapan berkas-berkasnya untuk diverifikasi guna penetapan NIPnya.</span></p>\r\n\r\n<p><span style=\"font-size:14px\">Demikian penyampaian kami, atas perhatian Bapak kami sampaikan terimakasih.</span></p>\r\n', '<div style=\"width:100%; text-align: center\"> <h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3> <table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">      <thead>         <tr>             <th>NO</th>             <th>NAMA</th>             <th>NIP</th>         </tr>     </thead>      <tbody>         <tr>             <td></td>             <td></td>             <td></td>         </tr>     </tbody>  </table> </div>'),
(17, 'BKPPD.870', 'Undangan', '<p style=\"text-align:center\"><span style=\"font-size:14px\">Dengan hormat, Badan Kepegawaian Pendidikan Pelatihan Daerah Kabupaten Manggarai Barat akan menggadakan rapat pembentukan panitia penerimaan CPNS Tahun 2018 yang akan dilaksanakan pada:</span></p>\r\n\r\n<p style=\"text-align:center\"><span style=\"font-size:14px\">Hari/ tanggal : Senin 25 Juni 2018<br />\r\nwaktu : pukul 08.00 pagi - Selesai<br />\r\nTempat : Kantor BKPPD<br />\r\nAcara : Pembentukan Panitia Penerimaan CPNS</span></p>\r\n\r\n<p style=\"text-align:center\"><span style=\"font-size:14px\">Sehubungan dengan hal tersebut diatas sangat penting, maka kami mohon dengan hormat untuk hadir tepat waktu dan tidak bisa diwakili.</span></p>\r\n\r\n<p style=\"text-align:center\"><span style=\"font-size:14px\">Demikian untuk maklum dan atas kerjasamamya diucapkan terima kasih.</span></p>\r\n', '<div style=\"width:100%; text-align: center\"> <h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3> <table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">      <thead>         <tr>             <th>NO</th>             <th>NAMA</th>             <th>NIP</th>         </tr>     </thead>      <tbody>         <tr>             <td></td>             <td></td>             <td></td>         </tr>     </tbody>  </table> </div>'),
(20, 'BKPPD.841', 'Laporan Keuangan', '<table align=\"center\" border=\"1\" cellspacing=\"0\" class=\"MsoTableGrid\" style=\"border-collapse:collapse; border:solid windowtext 1.0pt\">\r\n	<tbody>\r\n		<tr>\r\n			<td style=\"vertical-align:top; width:33.75pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">No</span></span></p>\r\n			</td>\r\n			<td style=\"vertical-align:top; width:205.65pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">Jenis Surat yang dikirim</span></span></p>\r\n			</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">Banyaknya</span></span></p>\r\n			</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">\r\n			<p style=\"margin-left:0cm; margin-right:0cm; text-align:center\"><span style=\"font-size:14px\"><span style=\"color:black\">Keterangan</span></span></p>\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<td style=\"vertical-align:top; width:33.75pt\">&nbsp;</td>\r\n			<td style=\"vertical-align:top; width:205.65pt\">&nbsp;</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">&nbsp;</td>\r\n			<td style=\"vertical-align:top; width:119.7pt\">&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n', '<div style=\"width:100%; text-align: center\"> \r\n<h3 >NOMINATIF USULAN PENETAPAN KARTU PEGAWAI</h3>     \r\n<h3 >KABUPATEN MANGGARAI BARAT</h3>      \r\n<table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">         \r\n    <thead>\r\n        <tr>             \r\n            <th>NO</th>\r\n            <th>NAMA/NIP</th>             \r\n            <th>TEMPAT/TGL LAHIR</th>             \r\n            <th>PANGKAT/GOL</th>             \r\n            <th>JABATAN</th>             \r\n            <th>UNIT KERJA</th>         \r\n            <th>KET</th>\r\n        </tr>  \r\n    </thead>   \r\n    <tbody>\r\n        <tr>             \r\n            <td>1</td>             \r\n            <td>2</td>             \r\n            <td>3</td>             \r\n            <td>4</td>             \r\n            <td>5</td>             \r\n            <td>6</td>  \r\n            <td>7</td>       \r\n        </tr>  \r\n    </tbody>            \r\n</table>\r\n</div>');
...
('SUK1001', 5, 1, '<div style=\"text-align:center; width:100%\">\r\n<h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3>\r\n\r\n<table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">\r\n	<thead>\r\n		<tr>\r\n			<th>NO</th>\r\n			<th>NAMA</th>\r\n			<th>NIP</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', 'BKPPD.890', '<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Sesuai Perihal Surat Edaran diatas, maka dengan ini disampaikan bhwa sertifikat Pendidikan dan Pelatihan Teknis Tugas dan Fungsi PNS Lingkup Pemerintah Kabupaten Manggarai Barat sudah ada, oleh karena itu diminta bantuan pimpinan OPD agar menyampaikan kepada staf untuk segera mengambil sertifikat di Badan Kepegawaian Pendidikan dan Pelatihan Daerah Kabupaten Mangarai Barat cq. Bidang Perencanaan dan Diklat BKPPD Kabupaten Manggarai Barat setiap jam kerja.</span></span></p>\r\n\r\n<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Demikian untuk maklum dan atas kerjasamamya diucapkan terima kasih.</span></span></p>\r\n', '<p>siji ae</p>\r\n', '2018-12-31', 'SUK1001.pdf', 'IR. Sebastianus Wantung-19650804 199703 1 002', 1, 'asdf'),
('SUK1002', 5, 1, '<div style=\"text-align:center; width:100%\">\r\n<h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3>\r\n\r\n<table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">\r\n	<thead>\r\n		<tr>\r\n			<th>NO</th>\r\n			<th>NAMA</th>\r\n			<th>NIP</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', 'BKPPD.890', '<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Sesuai Perihal Surat Edaran diatas, maka dengan ini disampaikan bhwa sertifikat Pendidikan dan Pelatihan Teknis Tugas dan Fungsi PNS Lingkup Pemerintah Kabupaten Manggarai Barat sudah ada, oleh karena itu diminta bantuan pimpinan OPD agar menyampaikan kepada staf untuk segera mengambil sertifikat di Badan Kepegawaian Pendidikan dan Pelatihan Daerah Kabupaten Mangarai Barat cq. Bidang Perencanaan dan Diklat BKPPD Kabupaten Manggarai Barat setiap jam kerja.</span></span></p>\r\n\r\n<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Demikian untuk maklum dan atas kerjasamamya diucapkan terima kasih.</span></span></p>\r\n', '<p>lebih tekok 1</p>\r\n', '2018-12-31', 'SUK1002.pdf', 'IR. Sebastianus Wantung-19650804 199703 1 002', 1, 'asdf'),
('SUK1003', 5, 1, '<div style=\"text-align:center; width:100%\">\r\n<h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3>\r\n\r\n<table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">\r\n	<thead>\r\n		<tr>\r\n			<th>NO</th>\r\n			<th>NAMA</th>\r\n			<th>NIP</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', 'BKPPD.890', '<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Sesuai Perihal Surat Edaran diatas, maka dengan ini disampaikan bhwa sertifikat Pendidikan dan Pelatihan Teknis Tugas dan Fungsi PNS Lingkup Pemerintah Kabupaten Manggarai Barat sudah ada, oleh karena itu diminta bantuan pimpinan OPD agar menyampaikan kepada staf untuk segera mengambil sertifikat di Badan Kepegawaian Pendidikan dan Pelatihan Daerah Kabupaten Mangarai Barat cq. Bidang Perencanaan dan Diklat BKPPD Kabupaten Manggarai Barat setiap jam kerja.</span></span></p>\r\n\r\n<p><span style=\"font-size:14px\"><span style=\"font-family:Times New Roman,Times,serif\">Demikian untuk maklum dan atas kerjasamamya diucapkan terima kasih.</span></span></p>\r\n', '<p>mbek lampiran</p>\r\n', '2018-12-31', 'SUK1003.pdf', 'IR. Sebastianus Wantung-19650804 199703 1 002', 1, 'asdf'),
('SUK1004', 17, 1, '<div style=\"text-align:center; width:100%\">\r\n<h3>DAFTAR NAMA PESERTA DIKLAT TUGAS DAN FUNGSI PNSD TAHUN 2017</h3>\r\n\r\n<table align=\"center\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" style=\"text-align:justify; width:700px\">\r\n	<thead>\r\n		<tr>\r\n			<th>NO</th>\r\n			<th>NAMA</th>\r\n			<th>NIP</th>\r\n		</tr>\r\n	</thead>\r\n	<tbody>\r\n		<tr>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n			<td>&nbsp;</td>\r\n		</tr>\r\n	</tbody>\r\n</table>\r\n</div>\r\n', 'BKPPD.870', '<p style=\"text-align:center\"><span style=\"font-size:14px\">Dengan hormat, Badan Kepegawaian Pendidikan Pelatihan Daerah Kabupaten Manggarai Barat akan menggadakan rapat pembentukan panitia penerimaan CPNS Tahun 2018 yang akan dilaksanakan pada:</span></p>\r\n\r\n<p style=\"text-align:center\"><span style=\"font-size:14px\">Hari/ tanggal : Senin 25 Juni 2018<br />\r\nwaktu : pukul 08.00 pagi - Selesai<br />\r\nTempat : Kantor BKPPD<br />\r\nAcara : Pembentukan Panitia Penerimaan CPNS</span></p>\r\n\r\n<p style=\"text-align:center\"><span style=\"font-size:14px\">Sehubungan dengan hal tersebut diatas sangat penting, maka kami mohon dengan hormat untuk hadir tepat waktu dan tidak bisa diwakili.</span></p>\r\n\r\n<p style=\"text-align:center\"><span style=\"font-size:14px\">Demikian untuk maklum dan atas kerjasamamya diucapkan terima kasih.</span></p>\r\n', '<p>ganok lampiran e</p>\r\n', '2018-12-31', 'SUK1004.pdf', 'IR. Sebastianus Wantung-19650804 199703 1 002', 1, 'asdf');
...
INSERT INTO `tb_surat_masuk` (`id_surat_masuk`, `id_user`, `no_surat`, `no_agenda`, `indeks_masalah`, `perihal`, `tanggal_surat`, `tanggal_surat_penerimaan`, `file_surat`, `scan_surat`, `scan_surat2`, `status`, `instruksi`) VALUES
('SUM1001', 'PEG1006', 'no surat', 'asdf', 'asdf', 'asdf', '2018-12-31', '2018-12-31', 'SUM1001.pdf', 'SUM1001-1.jpg', 'SUM1001-2.jpg', 0, 'distribusi');
...
--
-- Indexes for table `tb_detail_surat_masuk`
--
ALTER TABLE `tb_detail_surat_masuk`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `tb_detail_surat_masuk`
--
ALTER TABLE `tb_detail_surat_masuk`
...
--
-- Ketidakleluasaan untuk tabel `tb_detail_surat_masuk`
--
ALTER TABLE `tb_detail_surat_masuk`
  ADD CONSTRAINT `tb_detail_surat_masuk_ibfk_1` FOREIGN KEY (`id_surat_masuk`) REFERENCES `tb_surat_masuk` (`id_surat_masuk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_detail_surat_masuk_ibfk_2` FOREIGN KEY (`id_jabatan`) REFERENCES `tb_jabatan` (`id_jabatan`) ON DELETE CASCADE ON UPDATE CASCADE;
